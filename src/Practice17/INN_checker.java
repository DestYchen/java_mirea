    ...
    public static void main(String[] args){
        ...
        while (true){
            ...
            try{
                ...
                checkInn(inn);
                break;
            } catch (INN_exception e){
                System.out.println(e.getLocalizedMessage());
            }
        }
        System.out.println("ИНН действителен");
    }
    public static boolean checkInn(BigInteger inn) throws INN_exception{
        int i = 0;
        ...
        if(i != 10 && i != 12) throw new INN_exception(inn);
        return true;
    }
}
